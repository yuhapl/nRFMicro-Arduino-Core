...
#define PIN_VCC_EXT          (21) // VCC_EXT is P0.13 (set low to disable 3v3)
#define VCC_EXT              (PIN_VCC_EXT)
...
#define D3 (3ul) // P0.20 (MOSI)
#define D4 (4ul) // P0.22 (MISO)
